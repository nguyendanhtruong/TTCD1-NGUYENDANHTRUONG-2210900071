...
namespace K22CNT4_NGUYENDANHTRUONG_2210900071.Controllers
{
    public class DanhMucsController : Controller
    {
        ...
        // GET: DanhMucs/NdtCreate
        public ActionResult NdtCreate()
        {
            return View();
        }

        // POST: DanhMucs/NdtCreate
        [HttpPost]
